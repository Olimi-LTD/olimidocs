...
```javascript
{
  ...
  "contact": {
    "details": {
      ...
      "email": "string | null",  // Email address of the contact (nullable)
      "type": "string | null",  // Type of contact (nullable)
      "is_confirmed": "boolean",  // Whether the contact is confirmed
      "is_phone_number_correct": "boolean"  // Whether the phone number is correct
    },
    "roster_attachment": "string | null"  // URL to the roster attachment (nullable)
  },
